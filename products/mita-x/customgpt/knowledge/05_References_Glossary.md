...
```
Used for: Evaluating and improving offers, pricing, and risk reversal design.

### 2. The Funnel Diagnostic Chain (Mita-X internal)
```
...
- Cold (unaware) → Lead with pain/problem.
- Warm (solution aware) → Lead with mechanism/differentiation.
- Hot (product aware) → Lead with offer/urgency.

### 4. The 1-3-1 Copy Framework
Structure for primary ad text:
- 1 hook (interrupt the scroll)
...
## Key Meta Ads Platform Resources
- Meta Blueprint: https://www.facebook.com/business/learn
- Meta Business Help Center: https://www.facebook.com/business/help
- Meta Ads Policies: https://www.facebook.com/policies/ads/
- CAPI Setup Guide: https://developers.facebook.com/docs/marketing-api/conversions-api

## Indonesia Market Context
- Majority of transactions and final decision-making happen via WhatsApp for SMEs.
- Mobile-first market: > 90% of Meta usage via mobile. LP must be mobile-optimized first.
...
| Bahasa Indonesia | English | Arti Singkat |
|---|---|---|
| CTR / Tingkat Klik | Click-Through Rate | % dari yang melihat iklan lalu klik |
| CPC / Biaya per Klik | Cost Per Click | Biaya rata-rata per klik |
| CPM / Biaya per Seribu Tayang | Cost Per Mille | Biaya per 1000 tayangan |
| CVR / Tingkat Konversi | Conversion Rate | % pengunjung yang beli/daftar |
| CPA / Biaya per Akuisisi | Cost Per Acquisition | Biaya untuk dapat 1 pembeli |
| ROAS | Return on Ad Spend | Revenue ÷ Biaya iklan |
| MER | Marketing Efficiency Ratio | Total revenue ÷ Total biaya marketing |
| Frekuensi | Frequency | Rata-rata berapa kali orang melihat iklan yang sama |
| Jangkauan | Reach | Berapa orang unik yang melihat iklan |
| Tayangan | Impressions | Total berapa kali iklan muncul (termasuk orang yang sama) |
| Anggaran Harian | Daily Budget | Budget per hari yang diset di ad set |
...
| Retargeting | Iklan yang ditujukan ke warm/hot audience. |
| Prospecting | Iklan yang ditujukan ke cold audience baru. |

---

## Campaign Health Terms
